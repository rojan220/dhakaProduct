...
@section('content')
  <div class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <form method="post" action="{{ route('purchase.store') }}" autocomplete="off" class="form-horizontal">
            @csrf
            @method('post')
            ...
            <div class="card ">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('cart') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('cart') ? ' is-invalid' : '' }}" name="cart" id="input-cart" type="text" placeholder="{{ __('Cart') }}" value="{{ old('cart') }}" required="true" aria-required="true"/>
                      @if ($errors->has('cart'))
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('ra') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('ra') ? ' is-invalid' : '' }}" name="ra" id="input-ra" type="text" placeholder="{{ __('Ra') }}" value="{{ old('ra') }}" required="true" aria-required="true"/>
                      @if ($errors->has('ra'))
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('address1') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('address1') ? ' is-invalid' : '' }}" name="address1" id="input-address1" type="text" placeholder="{{ __('Address1') }}" value="{{ old('address1') }}" required="true" aria-required="true"/>
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('zip_code') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('zip_code') ? ' is-invalid' : '' }}" name="zip_code" id="input-zip_code" type="text" placeholder="{{ __('Zip code') }}" value="{{ old('zip_code') }}" required="true" aria-required="true"/>
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('status') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('status') ? ' is-invalid' : '' }}" name="status" id="input-status" type="text" placeholder="{{ __('Status') }}" value="{{ old('status') }}" required="true" aria-required="true"/>
              ...
              <div class="card-footer ml-auto mr-auto">
                <button type="submit" class="btn btn-primary">{{ __('Add Purchase') }}</button>
              </div>
            </div>
          </form>
        </div>
